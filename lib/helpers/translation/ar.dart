Map<String, String> arabicStrings = {
  ...
  'newPassword_didnt_match_confirmPassword':
      'كلمة المرور الجديدة لا تطابق تاكيد كلمة المرور',
  ...
  'loanType_exception': 'يجب اختيار نوع السلفة',
  'amount_exception': 'يجب ادخال المبلغ المطلوب',
  'loanStartingDate_exception': 'يجب اختيار تاريخ بداية السلفة',
  ...
  'this_order_approved_from_one':
      'لقد تمت الموافقة على هذا الطلب من احد المدراء ولا يمكن التعديل عليه',
  ...
  'no_attendance_assign': 'متغيب عن العمل',
  'attendance_assign': 'تم تسجيل حضور',
  'attendance_and_leave_assign': 'انهى الدوام',
  ...
  'no_incoming_vacations': 'لا يوجد حالياً أجازات قادمة مسجلة',
  'previous_vacations': 'الأجازات السابقة',
  'no_previous_vacations': 'لا يوجد حالياً أجازات سابقة مسجلة',
  'Sat': 'سبت',
  'Sun': 'أحد',
  'Mon': 'أثنين',
  'Tue': 'ثلاثاء',
  ...
  'vacations_balance': ' رصيد الاجازات المتاحة',
  'days_available_to_use': 'ايام',
  'apology': 'تبرير',
