...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            ...
                            errorMessage:
                                'oldPassword_didnt_match_currentPassword'.tr,
                            suffixIcon: InkWell(
                              onTap: () {
                          ...
                          CustomTextFormField(
                            ...
                            secureText: securePassword,
                            errorMessage:
                                'newPassword_didnt_match_confirmPassword'.tr,
  ...
  void _changeMyPassword() async {
    ...
    try {
      var respons = await appController.changeMyPassword(
          currentPassword: currentPasswordCrtl.text,
          newPassword: newPasswordCrtl.text,
          confirmPassword: confirmPasswordCrtl.text);
      SnackBars.showConfirmedSnackBar(
          'success'.tr, 'password_changed_success'.tr);
