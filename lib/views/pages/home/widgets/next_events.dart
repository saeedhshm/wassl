...
class NextEvents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Padding(
        ...
        child: controller.events.value.events.isNotEmpty
            ? Column(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    child: Row(
                      children: controller.events.value.events
                          .map((e) => ItemWidget(e))
                          .toList(),
                    ),
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/images/prosedures/cal.png',
                    width: 20,
                    color: AppColors.iconsColor,
                  ),
                  const SizedBox(
                  ...
                  Row(
                    children: [
                      Text(
                        event.startDate,
                        style: const TextStyle(
                            color: AppColors.lightGreyTextColor, fontSize: 9),
                      ),
                      const SizedBox(
                        width: 5,
                      ),
                      const BackArrowIcon(
                          color: AppColors.darkGreyTextColor, width: 20),
                      const SizedBox(
                        width: 5,
                      ),
                      Text(
