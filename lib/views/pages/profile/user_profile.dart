          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8,),
                DarkTextWidget('مصمم جرافيكس'),
                SizedBox(height: 20,),
                SizedBox(width:double.infinity,child: LightTextWidget('anual_vacations',fontSize: 17,)),
                SizedBox(height: 10,),
                ...
                SizedBox(height: 20,),
                SizedBox(width:double.infinity,child: LightTextWidget('profile',fontSize: 17,)),
                SizedBox(height: 10,),
                InkWell(
                  onTap: (){
                    Get.to(()=>InfoPage());
