    ...
    if (order != null) {
      ...
      if (controller.selectedType!.name.contains('عمل')) {
        ...
        controller.selectedCountry =
            holidayOrder.confirmation?.first.businessTrip?.country;
        await controller.getAllCities('${controller.selectedCountry?.id}');
        controller.selectedCity =
            holidayOrder.confirmation?.first.businessTrip?.region;
      ...
      controller.startDate = DateTime(
        int.tryParse(startDateArr?[0] ?? '') ?? 0,
        int.tryParse(startDateArr?[1] ?? '') ?? 0,
        int.tryParse(startDateArr?[2] ?? '') ?? 0,
      );
                                ...
                                children: [
                                  ...
                                  DropDownWidget<OrderType>(
                                    ...
                                    onSelectedIndex: (value) async {
                                      ...
                                      if (controller.selectedType?.name ==
                                          'رحلة عمل') {
                                        await controller.getAllCountries();
                                        controller.loadingCountries.value =
                                            true;
                                      } else {
                                        controller.loadingCountries.value =
                                            false;
                                  ...
                                  controller.differenceInDays.value.isNotEmpty
                                      ? Padding(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      SizedBox(
                                                        width: 20,
                                                        child: Image.asset(
                                                            'assets/images/order_details/calendar.png'),
                                                      ),
                                                      const SizedBox(
                                                        width: 8,
                                                      ),
                                                      ...
                                                      SizedBox(
                                                        width: 25,
                                                        child: Image.asset(
                                                            'assets/images/order_details/arrow.png'),
                                                      ),
                                                      const SizedBox(
                                                        width: 16,
                                                      ),
                                  ...
                                  controller.tripCost.value.trip != null
                                      ? Column(
                                          children: [
                                            const SizedBox(
                                              height: 15,
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    '${controller.tripCost.value.trip?.costPerDay}  ${'SAR'.tr}',
                                                    style: const TextStyle(
                                                        color: AppColors
                                                            .darkGreyTextColor,
                                                        fontSize: 16),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    '${controller.tripCost.value.totalCost}  ${'SAR'.tr}',
                                                    style: const TextStyle(
                                                        color: AppColors
                                                            .darkGreyTextColor,
                                                        fontSize: 16),
