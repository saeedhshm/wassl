...
class ExtraWorkRequest extends StatelessWidget {
  ...
  ExtraWorkRequest({Key? key, this.onClose, this.order}) : super(key: key) {
    if (order != null) {
      ...
      controller.overTimeDate = DateTime(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  controller.overTimeDate =
                                      selectedDate ?? controller.overTimeDate;
                                  if (controller.overTimeDate != null) {
                                    dateCtrl.text =
                                        '${controller.overTimeDate?.year}-${controller.overTimeDate?.month}-${controller.overTimeDate?.day} ';
                                  } else {
                                    dateCtrl.text = '';
                                  }
                                },
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (controller.startTime.value != '') {
                                    startTimeCtrl.text = controller
                                        .startTime.value.timeFromTimeSelection;
                                  } else {
                                    startTimeCtrl.text = '';
                                  }
                                },
                                ...
                                onTap: () async {
                                  if (controller.startTime.value.isEmpty) {
                                    ...
                                    var selectedTime = await showTimePicker(
                                      ...
                                      initialTime: TimeOfDay(
                                          hour: controller.startTime.value
                                              .hourOfTimeSelection,
                                          minute: controller.startTime.value
                                              .minuteOfTimeSelection),
                                    );
                                    ...
                                    if (controller.endTime.value != '') {
                                      endTimeCtrl.text = controller
                                          .endTime.value.timeFromTimeSelection;
                                    } else {
                                      endTimeCtrl.text = '';
                                    }
                                  }
