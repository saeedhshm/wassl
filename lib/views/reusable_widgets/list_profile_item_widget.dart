          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Image.asset(icon,width: iconSize,color: AppColors.iconsColor,),
                SizedBox(width: spaceInBetween,),
                DarkTextWidget(title,fontSize: fontSize,fontWeight: fontWeight,),
                const Spacer(),
                Image.asset('assets/images/list_arrow_item_${'lang_code'.tr}.png',width: 35,color: AppColors.iconsColor,)
